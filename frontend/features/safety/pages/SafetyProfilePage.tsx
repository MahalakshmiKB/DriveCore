...
const PROFILE = {
  ...
  email: 'sarah.jenkins@drivecore.in',
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex flex-col gap-1">
        <h1 className="text-3xl font-bold tracking-tight text-foreground font-sans">Officer Profile</h1>
            ...
            <CardContent className="pt-6 flex flex-col items-center gap-4">
              <Avatar className="size-20 border border-border/40 shadow-premium-md rounded-2xl">
                <AvatarFallback className="bg-primary/10 text-primary font-bold text-2xl">
                  {user?.avatarFallback || 'SJ'}
                </AvatarFallback>
              </Avatar>
              <div>
                <h3 className="text-lg font-bold text-foreground">{user?.name || 'Safety Officer'}</h3>
        ...
        <div className="lg:col-span-8 space-y-6">
            ...
            <CardContent className="pt-5">
              <div className="grid gap-4 sm:grid-cols-2 text-xs">
                <div>
                  ...
                  <span className="font-semibold text-white">{user?.name || 'Safety Officer'}</span>
                </div>
                <div>
                  <span className="text-slate-400 block text-[9px] font-bold uppercase tracking-wider">Role</span>
                  <span className="font-semibold text-white">Safety Officer</span>
                </div>
                <div>
          ...
          <Card className="border border-border/45 bg-card rounded-[20px] shadow-premium-sm">
            ...
            <CardContent className="pt-5 space-y-4 text-xs">
              ...
              <div className="flex items-center justify-between border-b border-border/20 pb-4">
                <div>
                  <div className="font-bold text-foreground">Incident Push Alerts</div>
                  <div className="text-[10px] text-slate-400 mt-0.5">Receive alerts when new incidents are reported.</div>
                </div>
